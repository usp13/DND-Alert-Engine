  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[var(--card)] hover:bg-[var(--card-hover)] p-6 rounded-3xl border border-red-500/30 hover:border-red-500/60 transition-all flex flex-col justify-between shadow-lg shadow-red-500/5 animate-pulse-red group">
          <div className="flex items-center justify-between mb-3">
